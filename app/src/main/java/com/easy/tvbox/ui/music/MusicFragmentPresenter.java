...
public class MusicFragmentPresenter extends BasePresenter<MusicFragmentView> {

    @Inject
    public MusicFragmentPresenter() {
     ...
     */
    public void queryMusic(int page, String shopNo, int videoId) {
        Map<String, Object> map = new HashMap<>();
        map.put("shopNo", shopNo);
        map.put("videoId", videoId);
        Disposable disposable = requestStore.queryForMusic(page, 20, map)
                .map(respond -> {
