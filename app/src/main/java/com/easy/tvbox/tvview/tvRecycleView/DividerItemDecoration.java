...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a =
                context.obtainStyledAttributes(attrs, R.styleable.TvRecyclerView_DividerItemDecoration, defStyle, 0);

        final Drawable divider = a.getDrawable(R.styleable.TvRecyclerView_DividerItemDecoration_android_divider);
        if (divider != null) {
