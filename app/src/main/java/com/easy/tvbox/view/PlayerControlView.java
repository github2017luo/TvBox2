...
public class PlayerControlView extends FrameLayout {
    ...
    private void requestPlayPauseFocus() {
        ...
        if (!playing && playButton != null) {
            boolean playF = playButton.requestFocus();
            Log.d("Focustv", "playButton.focus:" + playF);
        } else if (playing && pauseButton != null) {
            boolean pauseF = pauseButton.requestFocus();
            Log.d("Focustv", "pauseButton.focus:" + pauseF);
        }
    }
