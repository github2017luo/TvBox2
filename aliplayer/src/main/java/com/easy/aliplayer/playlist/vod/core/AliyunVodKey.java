package com.easy.aliplayer.playlist.vod.core;
...
public class AliyunVodKey {
    ...
    public static final String KEY_NEW_VOD_VIDEO_LIST = "getVideoList";
    public static final String KEY_NEW_VOD_CATEID = "cateId";
