...
public class BrightnessDialog extends BaseGestureDialog {
     ...
     * @return 最终的亮度百分比
     */
    public static int getTargetBrightnessPercent(int currentBrightness,int changePercent) {
        Log.d("BrightnessDialog", "changePercent = " + changePercent + " , mCurrentBrightness  = " + currentBrightness);
        int newBrightness = currentBrightness - changePercent;
