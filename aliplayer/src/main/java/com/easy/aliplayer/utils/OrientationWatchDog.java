package com.easy.aliplayer.utils;
        ...
        if (mLandOrientationListener == null) {
            mLandOrientationListener = new OrientationEventListener(mContext, SensorManager.SENSOR_DELAY_NORMAL) {
                ...
                public void onOrientationChanged(int orientation) {
                    ...
                    boolean isPort = (orientation < 10 || orientation > 350) || (orientation < 190 && orientation > 170);
                    ...
                    if (isLand) {
                        ...
                        }else if(mOrientationListener != null && (orientation > 260 &&orientation < 280 )){
                            Log.d(TAG, "ToLandReverse");
